...
import ValidateReportModal from './page/ValidateReportModal'
import ImageCollection from './page/ImageCollection'
import 'react-native-gesture-handler';
const Stack = createStackNavigator();

export default ValidateReport = ({route}) => {
    ...
    return (
        ...
        <Stack.Navigator initialRouteName="ReportModal" screenOptions={{gestureEnabled:true, headerShown: false }}>
            <Stack.Screen name="ReportModal" component={ValidateReportModal} initialParams={route.params} />
